...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          <li class="active"><a href="{{ url('user/riwayatpengajuan') }}"><i class="glyphicon glyphicon-time"></i> <span>Pengajuan Peminjaman <br> Warkah</span></a></li>
    </section>
    <!-- /.sidebar -->
  </aside>
  ...
  <div class="content-wrapper">
    ...
    <button type="submit" class="btn btn-default"><i class="glyphicon glyphicon-search"></i></button>
		{{-- <input type="submit" value="CARI" class="glyphicon glyphicon-search"> --}}
    	</form><br>
      <div class="row">
        <div class="col-xs-12">
          <!-- /.box -->
            ...
            <div class="box-body">
              <table class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td> {{ $du->bukutanah }} </td>
                  <td>  
                    <a class="glyphicon glyphicon-file" <abbr title="Ajukan Peminjaman" style="color: #00e1ffe1" href="/user/peminjamanwarkah/{{ $du->id }}" ></a>
                  </td>
                </tr>
                @endforeach
              </table>
