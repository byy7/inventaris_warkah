        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1 class="text-center">
                    <strong>DATA WARKAH <br> KANTOR TANAH KABUPATEN BANYUASIN</strong><br><br>
                                    ...
                                    <tbody>
                                        @foreach ($admin as $a)
                                            <tr>
                                                ...
                                                <td> {{ $a->rak }} </td>
                                                <td>
                                                    <a class="fa fa-print" <abbr title="Cetak data"
                                                        style="color: #0289f7e3" target="_blank"
                                                        href="{{ url('admin/laporan') }}">&emsp;</a>
                                                    <a class="glyphicon glyphicon-edit" <abbr title="Edit data"
                                                        style="color: #ff8800e3"
                                                        href="/admin/edit/{{ $a->id }}">&emsp;</a>
                                                    <a class="glyphicon glyphicon-trash" <abbr title="Hapus data"
                                                        style="color: #ff0000e1"
                                                        onclick="return  confirm('Yakin ingin menghapus data?')"
                                                        href="/admin/hapus/{{ $a->id }}"></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
