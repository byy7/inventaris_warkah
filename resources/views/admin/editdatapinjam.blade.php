  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1 class="text-center">
        <strong>EDIT DATA PEMINJAMAN WARKAH</strong><br><br>
      </h1>
    </section>
    ...
    <section class="content container">
            ...
            <div class="form-row">
              ...
              <div class="m-5">
                <label class="form-label">No. Hak</label>
                <input type="text" name="no_hak" class="form-control" required="required" value="{{ $e->no_hak }}" >
              </div>
              <div class="m-3">
              ...
              <div class="m-3">
                ...
                <input type="text" name="koderak" class="form-control" required="required" value="{{ $e->koderak }}" >
              </div>
              <div class="m-3">
                <label class="form-label">Tanggal Peminjaman</label>
                <input type="date" name="tanggalpinjam" class="form-control" required="required" value="{{ $e->tanggalpinjam }}" >
              </div>
              <div class="m-3">
                <label class="form-label">Tanggal Pengembalian</label>
                <input type="date" name="tanggalkembali" class="form-control" required="required" value="{{ $e->tanggalkembali }}" >
              </div>
              <br><br>
              <center>
