  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1 class="text-center">
        <strong>DATA PEMINJAMAN DAN PENGEMBALIAN WARKAH <br> KANTOR TANAH KABUPATEN BANYUASIN</strong><br><br>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Data Peminjaman & Pengembalian Warkah</h3>
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    <tr>
                      ...
                      <td> {{ $p->tglpengembalian }} </td>
                      <td> {{ $p->status }} </td>
                      <td>
                          <a class="glyphicon glyphicon-check" <abbr title="Klik untuk mengubah status" style="color: #00ff22e1" onclick="return  confirm('Apakah warkah sudah dikembalikan?')" href="/admin/pengembalian/{{ $p->id }}" ></a>&emsp;
                      </td>
                    </tr>
                    @endforeach
                  </table>
